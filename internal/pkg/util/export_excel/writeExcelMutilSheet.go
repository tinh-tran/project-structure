...
func (a *DataSheetFetcher) GetSheetNames() []string {
...
func (a *DataSheetFetcher) NextSheet() Sheet {
...
func (a *SheetValues) NextRow() []Value {
	//append header
...
func (a *SheetValues) GetSheetName() string {
	return a.SheetName
}

func (a *SheetValues) SetHeader(titles []string) {
	a.Header = titles
}

func (a *SheetValues) SetValue(row, cell int, value interface{}, typeCell string) {
	if value != nil {
		var data Value
		data.Value = value
		data.Type = typeCell
...
func (a *SheetValues) SetRowValue(row int, value []Value) {
	if row >= 0 {
